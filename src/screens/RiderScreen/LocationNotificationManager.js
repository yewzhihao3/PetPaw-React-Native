...
const NOTIFICATION_ID_KEY = "LOCATION_NOTIFICATION_ID";
const NOTIFICATION_ACTIVE_KEY = "LOCATION_NOTIFICATION_ACTIVE";
const RIDER_ONLINE_STATUS_KEY = "RIDER_ONLINE_STATUS";

export const LocationNotificationManager = {
