...
const DriverLocationUpdateNotification = () => {
  const { manualLocationUpdate } = useDriverLocation();
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.text}>
        Update your location for accurate ride tracking
      </Text>
      <TouchableOpacity
        style={styles.button}
...
export default DriverLocationUpdateNotification;
